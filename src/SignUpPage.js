...
function SignUpPage({ onNavigate }) {
  ...
  const handleSubmit = (e) => {
    ...
    // Basic client-side validation before handing off to Supabase (to be wired up later)
    ...
    // Placeholder: will be replaced with a Supabase sign-up call.
    // For now, navigate directly to the role home page with the collected data.
    const userData = {
      fullName,
      email,
      role,
