...
| `GET /questions`                         | List all questions         | Lecturer      |
| `POST /questions`                        | Create a question          | Lecturer      |
| `PUT /questions/{id}`                    | Update a question          | Lecturer      |
| `DELETE /questions/{id}`                 | Delete a question          | Lecturer      |
...
| `GET /paper`                             | List all papers/exams      | Lecturer      |
| `POST /paper`                            | Create a paper             | Lecturer      |
| `GET /lecturer/dashboard`                | Analytics dashboard        | Lecturer      |
| `GET /lecturer/submissions/{id}`         | View submission details    | Lecturer      |
| `GET /analytics/overview`                | System-wide statistics     | Lecturer      |
| `GET /analytics/student/{id}`            | Per-student analytics      | Lecturer      |
| `GET /analytics/subject/{name}`          | Per-subject analytics      | Lecturer      |
